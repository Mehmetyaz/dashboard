...
class EditModeBackgroundPainter extends CustomPainter {
  ...
  void drawVerticalLines(Canvas canvas) {
    ...
    var sY = -0.0 -
        (offset.clamp(0, 100)) -
        (style.doubleLineHorizontal ? mainAxisSpace / 2 : 0);
  ...
  @override
  bool shouldRebuildSemantics(EditModeBackgroundPainter oldDelegate) {
    return true;
  }
}

class EditModeItemPainter extends CustomPainter {
  EditModeItemPainter(
      {required this.style,
  ...
  @override
  bool shouldRepaint(EditModeItemPainter oldDelegate) {
    return constraints != oldDelegate.constraints;
  }

  @override
  bool shouldRebuildSemantics(EditModeItemPainter oldDelegate) {
    return true;
  }
}
